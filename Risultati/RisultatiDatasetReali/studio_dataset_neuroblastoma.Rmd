...
La distanza euclidea risulta in questo dataset sempre la scelta migliore come valore del rispettivo iperparametro. 
...
Quindi verifichiamo che applicando l'algoritmo di clustering DBSCAN, la metrica di Calinski-Harabasz individua come miglior configurazione quella con i valori di 𝜀=3, minPts=12 e k_out=5 rispetto a quelle scelte.
...
L'analisi effettuata tramite la metrica di Calinski-Harabasz indica come miglior risultato la combinazione di DBSCAN come algoritmo di clustering con configurazione di iperparametri eps=3.0 e minPts=12. Notiamo inoltre come per K-means e DBSCAN il numero di cluster ottimali coincida(k=5) mentre per Hierarchical-clustering risulti diverso(k=4)
