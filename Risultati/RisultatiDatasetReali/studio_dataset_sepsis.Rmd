...
Quindi verifichiamo che applicando l'algoritmo di clustering K-means, la metrica di Calinski-Harabasz individua come miglior configurazione quella con il valore di k=3, distance="euclidean" ed nstart indifferente rispetto a quelle scelte.
