...
dataset <- na.omit(read.csv("~/Calinski_Harabasz_Thesis/Data/DatasetReali/journal.pone.0148699_S1_Text_Sepsis_SIRS_EDITED.csv"))
...
Notiamo inoltre come per K-means e Hierarchical-clustering il numero di cluster ottimali coincida(k=2) mentre per DBSCAN risulti diverso(k=3)