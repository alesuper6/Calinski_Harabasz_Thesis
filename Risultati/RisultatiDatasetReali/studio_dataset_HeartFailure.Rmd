...
dataset <- na.omit(read.csv("~/Calinski_Harabasz_Thesis/Data/DatasetReali/journal.pone.0158570_S2File_depression_heart_failure.csv"))
...
Quindi verifichiamo che applicando l'algoritmo di clustering DBSCAN, la metrica di Calinski-Harabasz individua come miglior configurazione quella con i valori di 𝜀=88 e minPts=15 rispetto a quelle scelte.
...
Per l'algoritmo di clustering Hierarchical clustering, la metrica di Calinski-Harabasz individua come miglior configurazione quella con tipo average-linkage rispetto alle altre opzioni con ottimo locale per k=3.
