...
Quindi verifichiamo che applicando l'algoritmo di clustering DBSCAN, la metrica di Calinski-Harabasz individua come miglior configurazione quella con i valori di 𝜀=20, minPts=5 e k_out=2 rispetto a quelle scelte.
...
Per l'algoritmo di clustering Hierarchical clustering, la metrica di Calinski-Harabasz individua come miglior configurazione quella con tipo average-linkage e distance indifferente rispetto alle altre opzioni, con ottimo locale per k=2.
...
Notiamo inoltre come per ogni algoritmo il numero di cluster ottimale risulti identico ed uguale a 2.
